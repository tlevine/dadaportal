...
BLOG_AUTHOR = "Thomas Levine"  # (translatable)
BLOG_TITLE = "Dada Portal"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://thomaslevine.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://thomaslevine.com/"
BLOG_EMAIL = "_@thomaslevine.com"
BLOG_DESCRIPTION = "Big Dada"  # (translatable)
...
POSTS = (
    ("canonical-articles/*.rst", "!", "post.tmpl"),
    ("canonical-articles/*.txt", "!", "post.tmpl"),
)
PAGES = (
